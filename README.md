# Boss Machine - CodeAcademy Project

## Project Overview

In this project, I create an entire API to serve information to a Boss Machine, a unique management application for today's most accomplished  entrepreneurs. I created create routes to manage your 'minions', your brilliant 'million dollar ideas', and to handle all the annoying meetings that keep getting added to your busy schedule.
...
In **server.js**, I added missing key functionality to allow it to run. 
